...
int main() {
    ...
    int MapX1 = Map_Distance; //첫 번째 장애물의 거리를 24으로 지정
    int MapX2 = Map_Distance; //두 번째 장애물의 거리를 24으로 지정
    int MapX3 = Map_Distance; //세 번째 장애물의 거리를 24으로 지정
    ...
    if (End == 0) {
        ...
        if (UserOrder == 1) {
            ...
            while (true) {                //게임 진행 코드
                ...
                if (MapX1 == 16)
                    MapX2_Flag += 1;; // 1번째 장애물의 위치가 1/3지점에 왔다면 2번째 장애물 출력을 위한 변수 초기화
                if (MapX1 == 8)
                    MapX3_Flag += 1;  // 1번째 장애물의 위치가 2/3지점에 왔다면 3번째 장애물 출력을 위한 변수 초기화
                if (MapX2_Flag == 1) {
                    Map2(MapX2);
                    MapX2 -= 2;
                }
