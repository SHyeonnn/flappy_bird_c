...
int main() {
    Console();
    void Map1(Map_Position1); // 첫번째 장애물 모양 그리기
    void Map2(TreePosition2); // 두번째 장애물 모양 그리기
    int MapX1 = Map_Distance; //첫 번째 장애물의 거리를 50으로 지정
    int MapX2 = Map_Distance; //두 번째 장애물의 거리를 50으로 지정
